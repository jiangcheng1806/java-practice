package com.jiangc.practice.common.util;
...
public class HttpClientUtil {
    ...
    private final static String RESP_CONTENT = "访问远程服务失败";
    ...
    public static String sendPostRequest(String reqURL, String param, String type) {
        ...
        try {
            ...
            logger.info("开始执行请求：" + reqURL + "params:"+ JacksonUtils.toJSONString(param));
            // reqURL = URLDecoder.decode(reqURL, ENCODE_CHARSET);
    ...
    /**
     * 增加ua,用法同sendPostRequest(String reqURL, String param, String type)
     * @param reqURL
     * @param param
     * @param type
     * @param ua
     * @return
     */
    public static String sendPostRequest(String reqURL, String param, String type,String ua) {
        String result = RESP_CONTENT;
        // 设置请求和传输超时时间
        HttpPost httpPost = new HttpPost(reqURL);
        // 这就有可能会导致服务端接收不到POST过去的参数,比如运行在Tomcat6.0.36中的Servlet,所以我们手工指定CONTENT_TYPE头消息
