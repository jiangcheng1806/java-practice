 ...
 */
package com.jiangc.practice.redis.utils;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Date date = addMinute(60 ,new Date());
    ...
    public static long hourBetweenTwoTime(String date1) throws ParseException {
        if (org.apache.commons.lang.StringUtils.isEmpty(date1)) {
            return 0;
        }
    ...
    public static final Date convertString2Date(String targetDate) throws ParseException {
        if (org.apache.commons.lang.StringUtils.isBlank(targetDate))
            return null;
        Date result = null;
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
